...
2. `MG导演脚本.md` 和 `mg-placement-plan.v1.json` 已批准，但正式 MG 片段尚未完成并通过抽帧检查：读 [references/02-build.md](references/02-build.md)。
3. 正式 MG 片段已完成并通过抽帧检查：读 [references/03-deliver.md](references/03-deliver.md)。
